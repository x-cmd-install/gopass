...
- **Star**: 7,220 · **Fork**: 562 · **开放 issue**: 1,326 · **贡献者**: 242

## 累计统计

- **发布数**: 105 · **已合并 PR**: 2026 · **开放 PR**: 6 · **已关闭 issue**: 1245 · **开放 issue**: 81 · **提交数**: 2353
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/gopass.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T04:57:05Z._
